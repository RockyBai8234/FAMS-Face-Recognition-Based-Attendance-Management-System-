...
# Initialize the camera once at the start
import tkinter as tk
from tkinter import *
import cv2
import csv
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:\\Users\\srina\\OneDrive\\Desktop\\vscode\\StudentDetails\\'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\\Users\\srina\\OneDrive\\Desktop\\vscode\\Attendance\\Manually Attendance\\-------Check atttendance-------"')
